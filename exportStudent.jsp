...
<body>
    ...
    <%
        String file = "F:/Study/5th-semester/Web-Engineering/apache-tomcat-8.5.40/webapps/java_project/styles/Exported_Files/exportedStudents.csv";
        try {
